            ...
            <div>
              ...
              <div class="text-left">
                <p class="font-weight-light mb-0 mt-2">
                  Amount:
                  <v-chip color="gray darken-2"
                    >{{ expense.currency }}.{{ expense.amount }}</v-chip
                  >
                </p>
        ...
        <v-card>
          <v-card-title primary-title>
            <div>
              ...
              <div class="text-left">
                <p class="font-weight-light mb-0 mt-2">
                  First Name: {{ expense.employee.first_name }}
                </p>
                <p class="font-weight-light">
                  Last Name: {{ expense.employee.last_name }}
                </p>
              </div>
            </div>
          </v-card-title>
          ...
          <v-card-title primary-title>
            <div>
              <h3 class="headline text-xs-center mb-1">
                Status:
                <v-chip :color="getColor(expense.approved)">{{
                  expense.approved
                }}</v-chip>
              </h3>
              <v-divider></v-divider>
